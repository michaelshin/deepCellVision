...
class CellVisionForm(forms.Form):
    ...
    frames = forms.IntegerField(error_messages={'required': 'Please enter the number of frames in your image', 'invalid': 'Please enter a valid number'}, help_text = "Enter the number of frames your image has", min_value = 1)
    channels = forms.IntegerField(error_messages={'required': 'Please enter the number of channels in your image', 'invalid': 'Please enter a valid number'}, help_text = "Enter the number of channels your image has", min_value = 1)
    target = forms.IntegerField(error_messages={'required': 'Please enter targeted frame', 'invalid': 'Please enter a valid number'}, help_text = "Enter the targeted frames", min_value = 1, max_value = frames)
