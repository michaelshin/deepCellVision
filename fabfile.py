"""
Starter fabfile for deploying the deepCellVision project.
...
# CHANGEME
env.hosts = ['user@deepCellVision.example.com']
env.code_dir = '/srv/www/deepCellVision'
env.project_dir = '/srv/www/deepCellVision/deepCellVision'
env.static_root = '/srv/www/deepCellVision/static/'
env.virtualenv = '/srv/www/deepCellVision/.virtualenv'
env.code_repo = 'git@github.com:user/deepCellVision.git'
...
def restart():
    ...
    with cd(env.code_dir):
        run("touch %s/deepCellVision/wsgi.py" % env.code_dir)
